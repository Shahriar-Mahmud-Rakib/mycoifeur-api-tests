// ============================================
// Exhaustive Test Suite: BALANCE_APPLE-PAY
...
test.describe('Exhaustive Tests for balance_apple-pay', () => {

    // ─── ENDPOINT: POST /api/v1/balance/apple-pay ───

    test('BALANCE_APPLE-PAY-1-POS-PERF: [Positive/Perf] Process Apple Pay wallet top-up with Tap token should respond under 2000ms', async ({ request }) => {
    ...
    test('BALANCE_APPLE-PAY-1-NEG-AUTH: [Negative/Auth] Process Apple Pay wallet top-up with Tap token should reject missing auth', async ({ request }) => {
        const response = await request.post(`${BASE_URL}/api/v1/balance/apple-pay`, {
