// ============================================
// Exhaustive Test Suite: AUTH_VERIFY-CODE
...
test.describe('Exhaustive Tests for auth_verify-code', () => {

    // ─── ENDPOINT: POST /api/v1/auth/verify-code ───

    test('AUTH_VERIFY-CODE-1-POS-PERF: [Positive/Perf] Verify Code should respond under 2000ms', async ({ request }) => {
