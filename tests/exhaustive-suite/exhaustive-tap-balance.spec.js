// ============================================
// Exhaustive Test Suite: TAP_BALANCE
...
test.describe('Exhaustive Tests for tap_balance', () => {

    // ─── ENDPOINT: POST /api/v1/tap/balance/callback ───

    test('TAP_BALANCE-1-POS-PERF: [Positive/Perf] Tap wallet balance top-up callback should respond under 2000ms', async ({ request }) => {
